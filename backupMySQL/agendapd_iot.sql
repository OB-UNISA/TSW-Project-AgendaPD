...
CREATE TABLE `iot` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `iot_ibfk_1` FOREIGN KEY (`id`) REFERENCES `utente` (`nomeUtente`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `iot` VALUES ('testDottore','test',3),('testDottore2','Root1',0),('testDottore3','test',3);
